...
import { Upload, Building2, Globe, Tag, FileText } from "lucide-react";
import { useState } from "react";
import { useQueryClient } from "@tanstack/react-query";
import { useUpdateSettings, BasicAlert } from "../../imports";
import { sponsorSchema } from "../../utils/validationSchemas";

export const Sponsor = ({ initialData }) => {
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-lg">
          ...
          <div className="form-field">
            ...
            <div className="input-field">
              ...
              <input
                type="text"
                className="input"
                placeholder="e.g., Tech, Retail, Finance"
          ...
          <div className="form-field">
            ...
            <div
              className={`grid grid-cols-2 gap-md ${
                formik.errors.budgetRange ? "text-red-600" : ""
              }`}
            >
              <input
                type="number"
                ...
                value={formik.values.budgetRange?.min}
                onChange={(e) =>
                  formik.setFieldValue("budgetRange", {
                    ...formik.values.budgetRange,
                    min: e.target.value,
                  })
                }
              />
              <input
                ...
                value={formik.values.budgetRange?.max}
                onChange={(e) =>
                  formik.setFieldValue("budgetRange", {
                    ...formik.values.budgetRange,
                    max: e.target.value,
          ...
          <div className="form-field">
            ...
            <textarea
              ...
              placeholder="Sponsorship preferences, interests, etc."
